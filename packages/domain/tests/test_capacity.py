...
def test_truck_capacity_feasible_reroute():
    ...
    existing_orders = [
        Order(order_id="O204", destination_agency_id="AGENCY-04", destination_agency_name="Agency 04", cases=15, lot_id="LOT-SAFE-99"),
        Order(order_id="O205", destination_agency_id="AGENCY-05", destination_agency_name="Agency 05", cases=21, lot_id="LOT-SAFE-99"),
    ]
    reroute_order_202 = [
        Order(order_id="O202", destination_agency_id="AGENCY-02", destination_agency_name="Agency 02", cases=22, lot_id="LOT-RECALL-88"),
    ]
...
def test_truck_capacity_infeasible_both_orders():
    ...
    both_orders = [
        Order(order_id="O202", destination_agency_id="AGENCY-02", destination_agency_name="Agency 02", cases=22, lot_id="LOT-RECALL-88"),
        Order(order_id="O203", destination_agency_id="AGENCY-03", destination_agency_name="Agency 03", cases=20, lot_id="LOT-RECALL-88"),
    ]
