...
| WP5 — Gemini 3.5 through ADK | `d65d1cf`, pending managed-output fix commit | 106 safe tests passed; 106 collected | First deployed run failed closed on truncated output; corrected deployment pending | IN PROGRESS | None |
