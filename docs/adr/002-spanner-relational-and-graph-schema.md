...
3. Custody traversal query reconciles exact physical inventory (96 unique cases of `LTC-4471`) without double-counting when cases move from Agency 01 to Sub-site 01.
